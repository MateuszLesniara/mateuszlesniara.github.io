...
class User {
    constructor(username, first_name, last_name, email, password, re_password, is_teacher) {
...
class AuthService {
    ...
    login(email, password) {
        return this.http.post('http://127.0.0.1:1234/token/', { email, password })
            .subscribe(data => {
            this.doLoginFirstName(data.first_name, data.last_name, data.access, data.is_teacher);
            localStorage.setItem('currentUser', data);
            this.currentUser = data;
        }, error => {
            console.log('Error: ', error.status, error.statusText);
            this.storeStatus(error.status);
        });
    }
    doLoginFirstName(first_name, last_name, token, isTeacher) {
        this.logIn();
    ...
    storeIsTeacher(isTeacher) {
        localStorage.setItem('isTeacher', isTeacher);
    }
    storeFirstName(first_name) {
        localStorage.setItem('user', first_name);
    }
    storeLastName(last_name) {
...
class EnrollmentService {
    ...
    enrollUser(user) {
        return this.http.post(this.urlRegister, user).subscribe(data => {
    ...
    enrollCourse(course) {
        ...
        this.http.post(this.urlCreateCourse, course, requestOptions)
            .subscribe(data => {
            console.log('Success', data);
...
/* harmony import */ var _services_auth_guard__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./_services/auth.guard */ "./src/app/_services/auth.guard.ts");
...
const routes = [
    ...
    { path: 'dashboard', component: _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_6__["DashboardComponent"], canActivate: [_services_auth_guard__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"]] },
    { path: 'course', component: _course_course_component__WEBPACK_IMPORTED_MODULE_7__["CourseComponent"], canActivate: [_services_auth_guard__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"]] }
];
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _services_auth_guard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_services/auth.guard */ "./src/app/_services/auth.guard.ts");
...
function AppComponent_ng_template_17_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_ng_template_17_Template_button_click_3_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11); const ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r10.logout(); });
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 26, vars: 6, consts: [["lang", "en"], ["charset", "utf-8"], ["name", "viewport", "content", "width=device-width, initial-scale=1, shrink-to-fit=no"], ["name", "description", "content", ""], ["name", "author", "content", ""], [1, "navbar", "navbar-expand-lg", "bg-light", "top-fixed"], [1, "container"], [4, "ngIf", "ngIfThen", "ngIfElse"], ["normalTitle", ""], ["loginTitle", ""], ["logoutBlock", ""], ["loginBlock", ""], [1, "py-5", "card-footer", "footer", "bg-dark", "align-self-baseline"], [1, "m-0", "text-center", "text-white"], ["href", "home", 1, "navbar-brand"], ["type", "button", "data-toggle", "collapse", "data-target", "#navbarResponsive", "aria-controls", "navbarResponsive", "aria-expanded", "false", "aria-label", "Toggle navigation", 1, "navbar-toggler"], [1, "navbar-toggler-icon"], [1, "navbar-brand"], [1, "collapse", "navbar-collapse"], [1, "navbar-nav", "ml-auto"], [1, "nav-item"], ["type", "button", "routerLink", "home/", 1, "rounded-pill", "btn", "btn-primary", 3, "click"], ["type", "button", "routerLink", "login", 1, "rounded-pill", "btn", "btn-primary"], ["type", "button", "routerLink", "register", 1, "rounded-pill", "btn", "btn-primary"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](25, "Copyright \u00A9 Your Website 2019");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["NgIf"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterOutlet"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterLink"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2FwcC5jb21wb25lbnQuY3NzIn0= */"] });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppComponent, [{
    ...
    }], function () { return [{ type: _services_auth_guard__WEBPACK_IMPORTED_MODULE_1__["AuthGuard"] }, { type: _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }]; }, null); })();
...
/* harmony import */ var _services_token_interceptor__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./_services/token.interceptor */ "./src/app/_services/token.interceptor.ts");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [_services_auth_guard__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"], { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HTTP_INTERCEPTORS"], useClass: _services_token_interceptor__WEBPACK_IMPORTED_MODULE_7__["HttpConfigInterceptor"], multi: true }], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_8__["HomeComponent"], _register_register_component__WEBPACK_IMPORTED_MODULE_9__["RegisterComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_10__["LoginComponent"], _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_11__["DashboardComponent"], _course_course_component__WEBPACK_IMPORTED_MODULE_12__["CourseComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClientModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                ...
                providers: [_services_auth_guard__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"], { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HTTP_INTERCEPTORS"], useClass: _services_token_interceptor__WEBPACK_IMPORTED_MODULE_7__["HttpConfigInterceptor"], multi: true }],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _models_post__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../_models/post */ "./src/app/_models/post.ts");
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_services/auth.service */ "./src/app/_services/auth.service.ts");
...
function CourseComponent_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function CourseComponent_ng_template_8_Template_form_ngSubmit_12_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); const ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r6.createPost(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function CourseComponent_ng_template_8_Template_input_ngModelChange_17_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); const ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r8.postModel.title = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function CourseComponent_ng_template_8_Template_input_ngModelChange_24_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r9.postModel.body = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function CourseComponent_ng_template_8_Template_input_ngModelChange_32_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); const ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r10.postModel.file = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _models_course__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../_models/course */ "./src/app/_models/course.ts");
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_services/auth.service */ "./src/app/_services/auth.service.ts");
/* harmony import */ var _services_enrollment_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_services/enrollment.service */ "./src/app/_services/enrollment.service.ts");
...
function DashboardComponent_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function DashboardComponent_ng_template_8_Template_form_ngSubmit_12_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10); const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r9.create(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DashboardComponent_ng_template_8_Template_input_ngModelChange_17_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10); const ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r11.courseModel.title = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DashboardComponent_ng_template_8_Template_input_ngModelChange_24_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10); const ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r12.courseModel.body = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
function DashboardComponent_ul_14_Template(rf, ctx) { if (rf & 1) {
    const _r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "ul", 32);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DashboardComponent_ul_14_Template_ul_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r15); const courseModel_r13 = ctx.$implicit; const ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r14.onSelect(courseModel_r13); });
    ...
    const courseModel_r13 = ctx.$implicit;
...
class DashboardComponent {
    constructor(authService, enrollmentService, http, router) {
        this.authService = authService;
    ...
    ngOnInit() {
        this.id = this.authService.getLoggedUser();
        this.http.get('http://127.0.0.1:1234/api/courses/teacher_courses/').subscribe(data => {
            console.log(data),
                this.courses = data;
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DashboardComponent, [{
    ...
    }], function () { return [{ type: _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] }, { type: _services_enrollment_service__WEBPACK_IMPORTED_MODULE_3__["EnrollmentService"] }, { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] }]; }, null); })();
...
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["app-home"]], decls: 58, vars: 0, consts: [["lang", "en"], ["charset", "UTF-8"], ["id", "banner", 1, "img-fluid"], [1, "p-5", "masthead", "text-center", "text-white"], [1, "masthead-content"], [1, "container"], [1, "m-5", "p-5", "bg-primary", "text-white"], [1, "btn", "btn-primary", "btn-xl", "rounded-pill", 2, "margin-top", "100px", 3, "click"], [1, "bg-circle-1", "bg-circle"], ["target", ""], [1, "row", "align-items-center"], [1, "col-lg-6", "order-lg-2"], [1, "p-5"], ["src", "../../assets/images/easy.png", "alt", "", 1, "img-fluid", "rounded-circle"], [1, "col-lg-6", "order-lg-1"], [1, "display-4"], [1, "bg-primary", "text-white", "p-2"], [1, "col-lg-6"], ["src", "../../assets/images/quiz.png", "alt", "", 1, "img-fluid", "rounded-circle"], ["src", "../../assets/images/chat.png", "alt", "", 1, "img-fluid", "rounded-circle"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_a_click_13_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r1); const _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](21); return ctx.scroll(_r0); });
...
/* harmony import */ var _models_login__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_models/login */ "./src/app/_models/login.ts");
...
class LoginComponent {
    constructor(authService, formBuilder, router, authGuard) {
        this.authService = authService;
...
LoginComponent.ɵfac = function LoginComponent_Factory(t) { return new (t || LoginComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_auth_guard__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"])); };
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 25, vars: 7, consts: [[1, "container", "min-vw-100"], [1, "container"], ["role", "document", 1, "modal-dialog"], [1, "modal-content", "rounded"], [1, "modal-header"], ["id", "ModalLabel", 1, "modal-title"], [1, "modal-body"], ["class", "text-center text-danger", 4, "ngIf"], [3, "formGroup", "ngSubmit"], [1, "form-group"], ["for", "email"], ["id", "email", "type", "email", "required", "", "formControlName", "email", 1, "form-control", "rounded-pill"], ["class", "help-block", 4, "ngIf"], [1, "form-group", 3, "ngClass"], ["for", "password"], ["id", "password", "type", "password", "required", "", "formControlName", "password", 1, "form-control", "rounded-pill"], ["type", "submit", 1, "btn", "btn-primary", "rounded-pill"], [1, "modal-footer"], ["type", "button", "routerLink", "", 1, "btn", "btn-secondary", "rounded-pill"], [1, "text-center", "text-danger"], [1, "help-block"], ["class", "text-danger", 4, "ngIf"], [1, "text-danger"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "body", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "div", 3);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LoginComponent, [{
    ...
    }], function () { return [{ type: _services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }, { type: _services_auth_guard__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"] }]; }, null); })();
...
/* harmony import */ var _services_enrollment_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_services/enrollment.service */ "./src/app/_services/enrollment.service.ts");
...
RegisterComponent.ɵfac = function RegisterComponent_Factory(t) { return new (t || RegisterComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_enrollment_service__WEBPACK_IMPORTED_MODULE_2__["EnrollmentService"])); };
RegisterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RegisterComponent, selectors: [["app-register"]], decls: 68, vars: 34, consts: [[1, "container"], ["role", "document", 1, "modal-dialog"], [1, "modal-content", "rounded"], [1, "modal-header"], ["id", "SModalLabel", 1, "modal-title"], [1, "modal-body"], ["novalidate", "", 3, "ngSubmit"], ["userForm", "ngForm"], [1, "form-group"], ["for", "SInputUsername"], ["type", "text", "required", "", "id", "SInputUsername", "name", "username", 1, "form-control", "rounded-pill", 3, "ngModel", "ngModelChange"], ["username", "ngModel"], [1, "text-danger"], ["for", "SInputFirstName"], ["type", "text", "required", "", "id", "SInputFirstName", "name", "firstName", 1, "form-control", "rounded-pill", 3, "ngModel", "ngModelChange"], ["firstName", "ngModel"], ["for", "SInputLastName"], ["type", "text", "required", "", "id", "SInputLastName", "name", "lastName", 1, "form-control", "rounded-pill", 3, "ngModel", "ngModelChange"], ["lastName", "ngModel"], ["for", "SInputEmail"], ["type", "email", "required", "", "ngNativeValidate", "", "id", "SInputEmail", "aria-describedby", "SemailHelp", "name", "email", 1, "form-control", "rounded-pill", 3, "ngModel", "ngModelChange"], ["email", "ngModel"], ["id", "SemailHelp", 1, "form-text", "text-muted"], ["for", "SInputPassword"], ["type", "password", "required", "", "pattern", "\\S{8,}", "id", "SInputPassword", "name", "password", 1, "form-control", "rounded-pill", 3, "ngModel", "ngModelChange"], ["password", "ngModel"], ["for", "SInputPasswordRepeat"], ["type", "password", "required", "", "pattern", "\\S{8,}", "id", "SInputPasswordRepeat", "name", "password", 1, "form-control", "rounded-pill", 3, "ngModel", "ngModelChange"], [4, "ngIf"], ["type", "button", "ngModel", "", "btn-radio", "true", "name", "isTeacher", 1, "btn", "btn-primary", "rounded-pill", "m-1", 3, "ngModel", "click", "ngModelChange"], ["type", "button", "ngModel", "", "btn-radio", "false", "name", "isTeacher", 1, "btn", "btn-primary", "rounded-pill", "m-1", 3, "ngModel", "click", "ngModelChange"], ["type", "submit", 1, "btn", "btn-primary", "rounded-pill", 3, "disabled"], [1, "modal-footer"], ["type", "button", "routerLink", "", 1, "btn", "btn-secondary", "rounded-pill"]], template: function RegisterComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RegisterComponent_Template_input_ngModelChange_12_listener($event) { return ctx.userModel.username = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RegisterComponent_Template_input_ngModelChange_19_listener($event) { return ctx.userModel.first_name = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RegisterComponent_Template_input_ngModelChange_26_listener($event) { return ctx.userModel.last_name = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RegisterComponent_Template_input_ngModelChange_33_listener($event) { return ctx.userModel.email = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RegisterComponent_Template_input_ngModelChange_42_listener($event) { return ctx.userModel.password = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RegisterComponent_Template_input_ngModelChange_49_listener($event) { return ctx.userModel.re_password = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RegisterComponent_Template_button_click_59_listener() { return ctx.userModel.is_teacher = true; })("ngModelChange", function RegisterComponent_Template_button_ngModelChange_59_listener($event) { return ctx.userModel.is_teacher = $event; });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RegisterComponent_Template_button_click_61_listener() { return ctx.userModel.is_teacher = false; })("ngModelChange", function RegisterComponent_Template_button_ngModelChange_61_listener($event) { return ctx.userModel.is_teacher = $event; });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RegisterComponent, [{
    ...
    }], function () { return [{ type: _services_enrollment_service__WEBPACK_IMPORTED_MODULE_2__["EnrollmentService"] }]; }, null); })();
...
module.exports = __webpack_require__(/*! C:\Users\mateu\WebstormProjects\untitled\src\main.ts */"./src/main.ts");
